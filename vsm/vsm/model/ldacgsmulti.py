...
class LdaCgsMulti(LdaCgsSeq):
    ...
    def __init__(self, corpus=None, context_type=None, K=20, V=0, Z=[],
                 alpha=[], beta=[], n_proc=2, seeds=None):
        #print "LDA MULTI" ,alpha
        """
	...
	if platform.system() == 'Windows':
        ...
        super(LdaCgsMulti, self).__init__(corpus=corpus, context_type=context_type,Z=Z,
